...
set stm32programmercli="E:\Installs\stmcubeide\stm32programmer\bin\STM32_Programmer_CLI.exe"
set stm32tpccli="E:\Installs\stmcubeide\stm32programmer\bin\STM32TrustedPackageCreator_CLI.exe"
