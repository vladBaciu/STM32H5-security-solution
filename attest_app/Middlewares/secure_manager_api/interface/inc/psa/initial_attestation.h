...
/**************************************************************************//**
 * @file          psa_ia.h
 * @brief         Code Module UKPSA - Initial Attestation sub-Module - Public API file.
 * @author        ProvenRun
 * @maintainer    ProvenRun
 * @ingroup
 ******************************************************************************
* @details This header contains the IA  public declarations used for
 *          interacting with the IA APIs.
 *
 *          This file must be included by the RoT Services that embed the
 *          IA APIs.
 *
 ******************************************************************************
 * @addtogroup    PSA_Initial_Attestation
 * @{
 */
...
/* Define that we are inside this file (definition is undone at IA end). */
#define  PSA_IA_H_INSIDE
 ...
 * produced tokens.
 */
#define PSA_INITIAL_ATTEST_MAX_TOKEN_SIZE (0x2BC)
