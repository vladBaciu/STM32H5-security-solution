...
#ifndef PSA_ERROR_NOT_PERMITTED
...
#ifndef PSA_ERROR_CORRUPTION_DETECTED
 ...
 * RFC 8032 Section 5.1.6 and Section 5.2.6 (a 64-byte string for Ed25519, a 114-byte
 * string for Ed448).
 */
...
/** The value of ST DUA Key ID that will be used by the Non-secure application.
 */
#define PSA_KEY_ID_ST_DUA_USER                  ((psa_key_id_t)0x3ffffffe)
/**@}*/
 ...
 * permitted by the key type and policy.
 *
 * For a key pair, this concerns the public key.
 */
