...
call "%projectdir%Helper\update_config.bat" >> %current_log_file%
if !errorlevel! neq 0 goto :error_config
...
set module_with_license_template_ota_oem_sign_xml="License\SM_Module_Image_with_License_template_ota_oem_sign.xml"
