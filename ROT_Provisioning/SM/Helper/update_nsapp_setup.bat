...
echo MyTest2
echo %code_image_file_project%
set /a xml_copied=0

if exist %code_image_bin_file_project% (if exist %code_image_file_project% (goto :update_xml))
set /a xml_copied=2
